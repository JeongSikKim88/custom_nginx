#define NGX_CONFIGURE " --prefix=/usr/local/cac --with-select_module --with-poll_module --with-threads --with-file-aio --with-http_realip_module --with-http_sub_module --with-http_flv_module --with-http_mp4_module --with-http_image_filter_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_slice_module --with-http_geoip_module --with-http_v2_module --with-pcre --with-pcre-jit --with-openssl=../openssl-1.1.1d --with-http_ssl_module --add-module=../nginx-module-vts --add-module=../nginx-rtmp-module --add-module=../headers-more-nginx-module --add-module=../ngx_http_lower_upper_case --add-module=../nginx_upstream_check_module --add-module=../nginx-aws-auth-module --add-module=../nginx-let-module --add-module=../echo-nginx-module --with-http_secure_link_module --add-module=../nginx-vod-module --with-threads --with-file-aio --with-debug"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/cac/"
#endif
